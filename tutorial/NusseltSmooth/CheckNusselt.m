...
disp(sprintf('Relative error: %%%.3g', abs(q_avg_sim-q_avg_an)/abs(q_avg_an)*100));

figure(1)
hold on
plot(t, q_w_sim,'linewidth',2)
plot(t, q_w_an,'--','linewidth',2)
legend('simulation','analytical','location','southeast')