...
const Foam::scalar Foam::interfaceSigmaProperties::convertToRad =
...
void Foam::interfaceSigmaProperties::correctContactAngle
(
...
void Foam::interfaceSigmaProperties::calculateK()
{
    const fvMesh& mesh = alpha1_.mesh();
...
Foam::interfaceSigmaProperties::interfaceSigmaProperties
(
...
Foam::interfaceSigmaProperties::surfaceTensionForce() const
{
    return fvc::interpolate(sigmaK())*fvc::snGrad(alpha1_);
}

Foam::tmp<Foam::volScalarField>
Foam::interfaceSigmaProperties::nearInterface() const
{
